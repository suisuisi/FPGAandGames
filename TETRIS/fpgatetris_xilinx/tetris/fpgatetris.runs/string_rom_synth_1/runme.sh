...
HD_PWD='C:/Users/Administrator/Desktop/yafpgatetris/fpgatetris/fpgatetris.runs/string_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log string_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source string_rom.tcl
