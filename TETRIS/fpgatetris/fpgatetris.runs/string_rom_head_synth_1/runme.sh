...
HD_PWD='C:/Users/Administrator/Desktop/yafpgatetris/fpgatetrisV1/fpgatetris.runs/string_rom_head_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log string_rom_head.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source string_rom_head.tcl
