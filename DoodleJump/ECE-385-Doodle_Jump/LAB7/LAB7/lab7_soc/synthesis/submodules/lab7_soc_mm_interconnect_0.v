...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [25:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [101:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> switch_s1_agent:cp_data
	...
	wire  [102:0] key3_s1_agent_rf_source_data;                                                       // key3_s1_agent:rf_source_data -> key3_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] key3_s1_agent_rsp_fifo_out_data;                                                    // key3_s1_agent_rsp_fifo:out_data -> key3_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> key3_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // key3_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> key3_s1_agent:cp_channel
	...
	wire  [101:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [101:0] key3_s1_agent_rp_data;                                                              // key3_s1_agent:rp_data -> router_009:sink_data
