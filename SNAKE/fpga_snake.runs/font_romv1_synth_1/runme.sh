...
HD_PWD='C:/Users/Administrator/Downloads/fpga_snake-master/fpga_snake/fpga_snake.runs/font_romv1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log font_romv1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source font_romv1.tcl
